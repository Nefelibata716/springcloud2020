...
public class OrderController {
    ...
    @GetMapping(value = "/order/getConsulTest")
    public CommonResult getConsulTest(){
        return restTemplate.getForObject(PAYMENT_SERVICE+"/payment/getConsulTest",CommonResult.class);
    }
}
